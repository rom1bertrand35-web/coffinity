...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#EBE2D4] text-[#1A0F0A] selection:bg-[#B44222] selection:text-white overflow-x-hidden">
      ...
      {/* HEADER / NAV */}
      <nav className="p-6 md:px-12 md:py-10 flex justify-between items-center max-w-7xl lg:max-w-[1600px] mx-auto relative z-10">
      ...
      <section className="px-6 py-32 max-w-7xl lg:max-w-[1600px] mx-auto space-y-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 2xl:gap-16">
          {/* Card 1: 7 columns */}
          <BentoCard 
...
function BentoCard({ title, desc, icon, illustration, className = "", accent = false }: any) {
  return (
    ...
    >
      ...
      <p className="text-lg font-medium text-[#1A0F0A]/70 leading-relaxed relative z-10 max-w-sm lg:max-w-lg">{desc}</p>
      {illustration}
    </motion.div>
  );
}
